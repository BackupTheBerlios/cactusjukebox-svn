#
# Don't edit, this file is generated by FPCMake Version 2.0.0 [2008/10/28]
#
default: all
...
override PACKAGE_NAME=cactusjukebox
override PACKAGE_VERSION=0.4stable
ifndef LCL_PLATFORM
...
override CLEAN_FILES+=$(wildcard source/*$(OEXT)) $(wildcard source/*$(PPUEXT)) $(wildcard source/*$(RSTEXT))  $(wildcard source/*$(STATICLIBEXT))
endif
...
ifeq ($(FULL_TARGET),i386-linux)
override COMPILER_UNITDIR+=$(LCL_DIRECTORY)/lcl/units/$(CPU_TARGET)-$(OS_TARGET) $(LCL_DIRECTORY)/lcl/units/$(CPU_TARGET)-$(OS_TARGET)/$(LCL_PLATFORM)
endif
ifeq ($(FULL_TARGET),i386-go32v2)
override COMPILER_UNITDIR+=$(LCL_DIRECTORY)/lcl/units/$(CPU_TARGET)-$(OS_TARGET) $(LCL_DIRECTORY)/lcl/units/$(CPU_TARGET)-$(OS_TARGET)/$(LCL_PLATFORM)
endif
